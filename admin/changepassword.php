...
// Code for change password 
    ...
    <?php include('includes/sidebar.php'); ?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: #202020; font-size: 20px">Change Pasword</div>
                    </div>
    ...
    <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) {
        ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                                <button type="submit" name="change" class="btn" style="background: #4682B4; color: white" onclick="return valid();">Change</button>
