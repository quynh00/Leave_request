            ...
            <main class="mn-inner">
                ...
                <div class="card">
                    <div class="card-content">
                        <span class="card-title" style="color: #34403F; font-size: 20px">Not Approved Leave History</span>
                                ...
                                if ($query->rowCount() > 0) {
                                    foreach ($results as $result) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a <a style="color: #0033FF" href="editemployee.php?empid=<?php echo htmlentities($result->id); ?>" target="_blank"><?php echo htmlentities($result->FullName); ?>(<?php echo htmlentities($result->EmpId); ?>)</a></td>
