...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO employees(EmpId,FullName,EmailId,Password,Gender,Dob,Address,Phonenumber,Status) VALUES(:empid,:fullname,:email,:password,:gender,:dob,:address,:mobileno,:status)";
    ...
    <?php include('includes/sidebar.php'); ?>
            <main class="mn-inner">                                    
                <div class="page-title" style="color: #4682B4; font-size: 20px"><strong>Add employee</strong></div>
                <br>
                <br>
                <div class="card">
                    <div class="card-content">
                        <form id="example-form" method="post" name="addemp">
                            <div>
                                <d style="color: #34403F; font-size: 45px">Employee Information </d>
                                <section>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col-md-6">
                                                        <div class="text-center">
                                                            <button type="submit" name="add" onclick="return valid();" id="add" class="btn" style="width: 100px; background: SteelBlue; color:white"><strong>Add</strong></button>
                                                        </div>
                                                    </div>
