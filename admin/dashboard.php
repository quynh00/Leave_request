...
if (strlen($_SESSION['alogin']) == 0) {
                    ...
                    <div class="col-md-4" >
                        <div class="card stats-card" style="background: #00CED1;">
                            <div class="card-content" >
                                <span class="card-title" style="color: white; font-size: 15px">Totle Regd Employee</span>
    ...
    ?>
                    ...
                    <div class="col-md-4" >
                        <div class="card stats-card" style="background: #4682B4;">
                            <div class="card-content">
                                <span class="card-title" style="color: white;font-size: 15px">Listed leave </span>
    <?php
    ...
    ?>                            
                    ...
                    <div class="col-md-4" >
                        <div class="card stats-card" style="background: #C9D74F">
                            <div class="card-content">
                                <span class="card-title" style="color: white; font-size: 15px">Listed leave Type</span>
    <?php
    ...
    ?>   
                ...
                <div class="card invoices-card">
                    <div class="card-content" >
                        <span class="card-title" style="color: #202020;font-size: 20px">Latest Leave Applications</span>
